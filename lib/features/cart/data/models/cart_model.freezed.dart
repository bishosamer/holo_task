...
abstract class $CartModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@HiveField(0) List<CartItemModel> items});
}
...
class _$CartModelImpl implements _CartModel {
  const _$CartModelImpl(
      {@HiveField(0) final List<CartItemModel> items = const []})
      : _items = items;
...
abstract class _CartModel implements CartModel {
  const factory _CartModel({@HiveField(0) final List<CartItemModel> items}) =
      _$CartModelImpl;
